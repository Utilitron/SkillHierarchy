...
public class Flamberge implements SkillObject, Bladed, TwoHanded, SubSkill, SiblingSkill {
	...
	public Flamberge(SkillObject parentSkill) {
		this.parentSkill = parentSkill;
	}
	
	
	public String toString() {
		return "Flambere [Base Skill=" + getBaseSkill() + ", Calculated Skill=" + calculatedSkill() + "]";
	}
