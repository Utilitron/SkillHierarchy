...
public class Bardiche implements SkillObject, Poleaxe, TwoHanded, SubSkill, SiblingSkill {
	...
	public Bardiche(SkillObject parentSkill) {
		this.parentSkill = parentSkill;
	}
	
	
	public String toString() {
		return "Bardiche [Base Skill=" + getBaseSkill() + ", Calculated Skill=" + calculatedSkill() + "]";
	}
