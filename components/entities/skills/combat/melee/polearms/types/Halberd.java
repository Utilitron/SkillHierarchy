...
import components.entities.skills.combat.weapontypes.Poleaxe;
import components.entities.skills.combat.weapontypes.Spear;
import components.entities.skills.combat.weapontypes.TwoHanded;

public class Halberd implements  SkillObject, Spear, Poleaxe, TwoHanded, SubSkill, SiblingSkill {
	...
	public Halberd(SkillObject parentSkill) {
		this.parentSkill = parentSkill;
	}
	
	
	public String toString() {
		return "Halberd [Base Skill=" + getBaseSkill() + ", Calculated Skill=" + calculatedSkill() + "]";
	}
