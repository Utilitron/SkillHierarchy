...
public class Mace implements SkillObject, Bashing, OneHanded, SubSkill, SiblingSkill {
	...
	public Mace(SkillObject parentSkill) {
		this.parentSkill = parentSkill;
	}
	
	
	public String toString() {
		return "Mace [Base Skill=" + getBaseSkill() + ", Calculated Skill=" + calculatedSkill() + "]";
	}
