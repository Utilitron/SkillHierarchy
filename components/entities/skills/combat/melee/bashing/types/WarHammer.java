...
public class WarHammer implements SkillObject, Bashing, OneHanded, SubSkill, SiblingSkill {
	...
	public WarHammer(SkillObject parentSkill) {
		this.parentSkill = parentSkill;
	}
	
	
	public String toString() {
		return "War Hammer [Base Skill=" + getBaseSkill() + ", Calculated Skill=" + calculatedSkill() + "]";
	}
